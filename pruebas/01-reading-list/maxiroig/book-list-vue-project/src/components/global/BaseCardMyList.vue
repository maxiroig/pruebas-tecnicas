...
<template>
    <div class="w-full min-h-[290px] mt-2 ms-4 max-w-sm  bg-slate-800 border border-gray-500 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-auto">
        ...
        <div>
            <img class="mx-auto rounded-t-lg h-[170px] cursor-default" :src="props.cover" :alt="title" />
        </div>
        <div class="ps-8 pt-1">
            <div class="flex items-center mb-2 ps-4">
                <svg class="w-2 h-2 text-yellow-300 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                ...
                <span class="bg-blue-100 text-blue-800 text-[.6rem] font-semibold mr-2 px-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">4.0</span>
            </div>
            <div class="flex justify-between">
                <h5 class="text-xs font-semibold tracking-tight text-pink-600">
                    {{ title }}
                </h5>    
            </div>
            <div class="">
                <p class="text-xs leading-4 text-gray-400">
                    Author:
                    <span class="text-white text-xs leading-4">
                        {{ author }}
                    </span>
                </p>
                <p class="text-xs leading-4 text-gray-400">
...
.grow{
  ...
  .grow:hover{
    transform: scale3d(1.5, 1.5, 0.3);
        -webkit-transform: scale3d(1.7, 1.7, 0.3);
